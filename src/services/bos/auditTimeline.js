...
export const STATE_LABELS = {
  ...
  destination_release_unobserved: { label: 'Awaiting release evidence on destination chain', icon: '⏳', category: 'bridge' },
  destination_release_observed: { label: 'Release observed on destination chain', icon: '🔗', category: 'bridge' },
